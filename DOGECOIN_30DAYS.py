...
import joblib
# --- Dogecoin ---
model = load_model("Dogecoin.h5")
model.compile(optimizer='adam', loss='mean_squared_error', metrics=['mae'])
scaler = joblib.load("Dogecoin_scaler.save")
df = pd.read_csv("cleaned_Dogecoin.csv")
...
plt.plot(predicted_prices, label='Dogecoin Next 30 Days', color='orange')
